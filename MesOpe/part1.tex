...
\Rem{}{\begin{enumerate}
	\item Pour prouver qu'un opérateur $A$ est fermé, on procède en général de la manière suivante : on prend une suite $(u_n)$ dans $D(A)$ telle que $u_n\to u$ dans $E$ et $Au_n\to f$ dans $F$. Il s'agit ensuite de vérifier que 
		\begin{enumerate}
			\item $u\in D(A)$
			\item $f=Au$
		\end{enumerate}
